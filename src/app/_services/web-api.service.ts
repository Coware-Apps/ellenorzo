...
import { CommunityService } from "../_models/kreta-v2/communityService";
import { LayoutInformation } from "../_models/kreta-v2/layoutInformation";
...
export class WebApiService {
    ...
    constructor(private _http: HTTP, private _translator: TranslateService) {
            ...
            switch (error) {
                ...
                default:
                    if (error >= 500 && 600 > error) {
                        ...
                        this._translator.instant("services.kreta.httpErrors.defaultClientSide", {
                            error: error,
                        });
                    }
                    break;
    ...
    public async getUserInfo(): Promise<LayoutInformation> {
        ...
        try {
            ...
            let response = await this._http.post(
                `${this._instituteUrl}/Layout/GetLayoutInformation`,
                params,
                headers
            );
