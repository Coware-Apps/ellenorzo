...
} from "../_models/administration/message";
import { AddresseeType } from "../_models/administration/addresseeType";
import {
    FileTransfer,
    FileUploadOptions,
    FileTransferObject,
...
} from "../_models/administration/addresseeListItem";
import { AddresseeGroup } from "../_models/administration/adresseeGroup";
...
import {
    ...
    AdministrationInvalidResponseError,
    AdministrationTokenError,
    AdministrationFileError,
    AdministrationNetworkError,
    AdministrationInvalidGrantError,
    AdministrationRenewTokenError,
} from "../_exceptions/administration-exception";
...
export class AdministrationService {
    ...
    public async getToken(
        ...
        try {
            ...
            if (error instanceof SyntaxError)
                throw new AdministrationInvalidResponseError("getToken");
            if (error.status && error.status == 400)
                throw new AdministrationInvalidGrantError("getToken", error);
    ...
    public async renewToken(refresh_token: string, institute: Institute): Promise<Token> {
        try {
            ...
            if (error instanceof SyntaxError)
                throw new AdministrationInvalidResponseError("renewToken");
            if (error.status && error.status < 0)
                throw new AdministrationNetworkError("renewToken");
    ...
    public async getMessageList(
        ...
        try {
            let response = await this._http.get(
                this._host + this._endpoints[`${state}List`],
                params,
                headers
            );
    ...
    public async getMessage(messageId: number, tokens: Token): Promise<AdministrationMessage> {
        ...
        try {
            let response = await this._http.get(
                this._host + this._endpoints.message + `/${messageId}`,
                params,
                headers
            );
    ...
    public async deleteMessages(messageIdList: number[], tokens: Token) {
        ...
        try {
            await this._http.delete(
                this._host + this._endpoints.delete + quersStr,
                params,
                headers
            );
        } catch (error) {
    ...
    public async changeMessageState(
        ...
        try {
            ...
            this.basicErrorHandler(
                "changeMessageState()",
                error,
                "changeMessageState.title",
                "changeMessageState.text"
            );
        } finally {
            this._http.setDataSerializer("urlencoded");
        }
    ...
    public async getAddresseeGroups(
        ...
        try {
            ...
            this.basicErrorHandler(
                "getAddresseeGroups()",
                error,
                "adresseeLoading.title",
                "adresseeLoading.text"
            );
        }
    }
    /**
    ...
    public async sendNewMessage(
        ...
        this._firebase.logEvent("send_new_message");
    ...
    public async getAddresseeTypeList(tokens: Token): Promise<AddresseeType[]> {
        ...
        try {
            let response = await this._http.get(
                this._host + this._endpoints.addresseeTypesList,
                params,
                headers
            );
    ...
    public async getAddresseeListByCategory(
        ...
        try {
            let response = await this._http.get(
                this._host + this._endpoints.addresseeCategories[category],
                params,
                headers
            );
            ...
            this.basicErrorHandler(
                "getAddresseeListByCategory()",
                error,
                "adresseeLoadingError.title",
                "adresseeLoadingError.text"
            );
        }
    }
    public async getStudentsOrParents(
        ...
        try {
            let response = await this._http.get(
                this._host +
                    this._endpoints.addresseeCategories[category][by] +
                    `/${groupOrClassId}`,
                params,
                headers
            );
            ...
            console.error(
                `Error trying to get ${category} list by ${by}, with id: ${groupOrClassId}`,
                error
            );
            this.basicErrorHandler(
                "getStudentsOrParents()",
                error,
                "adresseeLoadingError.title",
                "adresseeLoadingError.text"
            );
    ...
    public async addAttachment(
        ...
        tokens: Token
    ): Promise<AttachmentToSend> {
        this._firebase.logEvent("add_message_attachment");
        ...
        try {
            if (this._platform.is("ios")) {
                ...
                if (using == "file") {
                    filePath = await this._filePath.resolveNativePath(
                        await this._fileChooser.open()
                    );
    ...
    public async getAttachment(
        ...
        this._firebase.logEvent("download_message_attachment");
