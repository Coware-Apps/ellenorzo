...
import { AdministrationError, AdministrationNetworkError } from 'src/app/_exceptions/administration-exception';
...
export class AdministrationErrorComponent implements OnInit {
  ...
  ngOnInit() {
    this.iconName = this.error instanceof AdministrationNetworkError ? "wifi-outline" : "bug-outline";
  }
